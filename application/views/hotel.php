                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-primary card-outline">
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('hotel/ubah/') . $value->id_hotel ?>"
                                                class="btn btn-sm btn-primary">Edit</a>
                                            <a href="<?php echo base_url('hotel/hapus/') . $value->id_hotel ?>"
                        ...
                        <div class="card-footer clearfix">
                            <a href=" <?php echo base_url('hotel/tambah') ?> " class="btn btn-xs btn-primary">Tambah
                                Data</a>
                        </div>
                    </div>
                </div>
