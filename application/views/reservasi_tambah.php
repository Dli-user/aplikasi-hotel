                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url('reservasi/simpan') ?>">
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="id_reservasi"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" name="tanggal_in"
                                        placeholder="Masukkan Id Tanggal In..." required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="time" class="form-control" name="jam_in"
                                        placeholder="Masukkan Jam In..." required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" name="tanggal_out"
                                        placeholder="Masukkan Tanggal Out..." required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="time" class="form-control" name="jam_out"
                                        placeholder="Masukkan Jam Out..." required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Biaya</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="biaya" placeholder="Masukkan Biaya..."
                                        required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="pajak" placeholder="Masukkan Pajak..."
                                        required>
                                </div>
                            </div>
                        </div>
