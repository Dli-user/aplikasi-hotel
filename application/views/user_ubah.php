                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url('user/update') ?>">
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" value="<?php echo $value->id_user; ?>"
                                        disabled>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="nama"
                                        value="<?php echo $value->nama; ?>" placeholder="Keterangan" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" name="akses_terakhir"
                                        value="<?php echo $value->akses_terakhir; ?>" placeholder="Keterangan" required>
                                </div>
                            </div>
                        </div>
